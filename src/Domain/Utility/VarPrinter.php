...
final class VarPrinter
{
    ...
    /**
     * Reads a string representation from an Enum
     */
    private static function readEnum(UnitEnum $enum): string
    {
        return sprintf('Enum(%s::%s)', ClassName::short($enum), $enum->name);
    }
