...
use Fight\Common\Domain\Collection\Contract\OrderedSet;
...
final class SortedSet implements OrderedSet
{
     ...
     */
    public function __construct(private Comparator $comparator, ?string $itemType = null)
    {
     ...
     * @inheritDoc
     */
    public static function comparable(string $itemType): static
    {
        assert(Validate::implementsInterface($itemType, Comparable::class));
