...
namespace Fight\Common\Domain\Collection;
...
use Fight\Common\Domain\Collection\Contract\OrderedTable;
use Fight\Common\Domain\Collection\Iterator\GeneratorIterator;
use Fight\Common\Domain\Collection\Traits\KeyValueTypeMethods;
use Fight\Common\Domain\Collection\Tree\BinarySearchTree;
...
final class SortedTable implements OrderedTable
{
     ...
     */
    public function __construct(private Comparator $comparator, ?string $keyType = null, ?string $valueType = null)
    {
     ...
     * @inheritDoc
     */
    public static function comparable(string $keyType, ?string $valueType = null): static
    {
        assert(Validate::implementsInterface($keyType, Comparable::class));
