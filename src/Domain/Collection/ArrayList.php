...
final class ArrayList implements ItemList
{
    ...
    {
        return array_any($this->items, fn($item, $index) => call_user_func($predicate, $item, $index));
    }
    ...
    {
        return array_all($this->items, fn($item, $index) => call_user_func($predicate, $item, $index));
    }
