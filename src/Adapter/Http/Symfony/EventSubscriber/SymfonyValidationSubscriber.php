 ...
 */
#[AsEventListener(event: KernelEvents::CONTROLLER, method: 'validateControllerInput')]
readonly class SymfonyValidationSubscriber implements EventSubscriberInterface
{
    /**
