...
final class ReleaseRuntimeTest extends UnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        copy(dirname(__DIR__, 3).'/bin/release', $this->directory.'/bin/release');
        chmod($this->directory.'/bin/release', 0755);

        file_put_contents($this->directory.'/release/scripts/release.php', <<<'PHP_WRAP'
        <?php
...
BASH
        ...
        foreach ([false, 'generic-container', self::CANONICAL_RUNTIME] as $sentinel) {
            ...
            self::assertStringContainsString(
                sprintf(
                    ...
                    $this->directory,
                    'release/scripts/release.php inspect --fixture=/fixture.json'
                ),
                $dockerLog
            );
        }
    ...
    {
        file_put_contents(
            $this->directory.'/release/scripts/release.php',
