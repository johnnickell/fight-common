...
class ReleasePlanJourneyTest extends UnitTestCase
{
    ...
    public function test_that_plan_persists_a_canonical_immutable_artifact_for_an_approved_exact_version(): void
    {
        ...
        try {
            $result = $this->plan($root, $root.'/release/fixtures/plan-candidate.json', $output);
            $idempotent = $this->plan($root, $root.'/release/fixtures/plan-candidate.json', $output);
            $equivalent = $this->plan($root, $root.'/release/fixtures/plan-candidate-equivalent.json', $output);
            $changed = $this->plan($root, $root.'/release/fixtures/plan-candidate-changed.json', $output);
    ...
    public function test_that_plan_refuses_a_corrupt_artifact_with_the_same_plan_identity(): void
    {
        ...
        try {
            $initial = $this->plan($root, $root.'/release/fixtures/plan-candidate.json', $output);
