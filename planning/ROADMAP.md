...
| [EPIC-00005](epics/00005-EPIC.md) | 1.2.0+ | in-progress | The exact documentation runtime, protected artifact-based Pages workflow, canonical Fight identity, browser-qualified Atlas Deck shell, validated repository entry surface, executable framework-neutral Quick Start, approved Hexagonal Architecture and CQRS guide, verified Mail reference component guide, all ten Domain and Application guides, and all nine remaining Connect Systems guides are complete through T-00096; T-00097 is the ready guide-completion frontier; hosted deployment and the separately governed GitHub-profile adaptation remain later boundaries |
