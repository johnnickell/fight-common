...
| [EPIC-00005](epics/00005-EPIC.md) | 1.2.0+ | in-progress | The exact documentation runtime, protected artifact-based Pages workflow, canonical Fight identity, and browser-qualified Atlas Deck shell are complete through T-00090; T-00091 through T-00094 are ready for the repository entry surface and first complete reader journeys, while hosted deployment and the separately governed GitHub-profile adaptation remain later boundaries |
