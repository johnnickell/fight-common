...
| [EPIC-00005](epics/00005-EPIC.md) | 1.2.0+ | in-progress | The exact documentation runtime, protected artifact-based Pages workflow, canonical Fight identity, browser-qualified Atlas Deck shell, validated repository entry surface, executable framework-neutral Quick Start, and approved Hexagonal Architecture and CQRS guide are complete through T-00093; T-00094 is the next ready reader journey; hosted deployment and the separately governed GitHub-profile adaptation remain later boundaries |
