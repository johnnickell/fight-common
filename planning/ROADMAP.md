...
| [EPIC-00005](epics/00005-EPIC.md) | 1.2.0+ | in-progress | The exact documentation runtime, protected artifact-based Pages workflow, canonical Fight identity, browser-qualified Atlas Deck shell, and validated repository entry surface are complete through T-00091; T-00092 through T-00094 are ready for the first complete reader journeys, while hosted deployment and the separately governed GitHub-profile adaptation remain later boundaries |
