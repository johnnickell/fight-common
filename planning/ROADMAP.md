...
| [EPIC-00005](epics/00005-EPIC.md) | 1.2.0+ | in-progress | The exact documentation runtime, protected artifact-based Pages workflow, and canonical Fight identity family are complete through T-00089; T-00090 is now the ready Atlas Deck shell frontier, while hosted deployment and the separately governed GitHub-profile adaptation remain later boundaries |
