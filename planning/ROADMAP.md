...
| [EPIC-00005](epics/00005-EPIC.md) | 1.2.0+ | in-progress | The exact documentation runtime, deterministic artifact contract, and protected artifact-based Pages workflow are complete through T-00088; T-00089 is now the ready identity prerequisite for the Atlas Deck and repository entry surfaces, while hosted deployment and the separately governed GitHub-profile adaptation remain later boundaries |
