...
Build the package through ordered user-valued slices. The first private `0.1.0` milestone completes invitation
...
39. As a package consumer, I want stable public commit references during private incubation, so that integration
