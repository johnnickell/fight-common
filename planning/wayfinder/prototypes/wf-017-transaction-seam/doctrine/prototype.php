...
$factory = static fn (): UnitOfWork => new DoctrineUnitOfWork(new EntityManager($connection, $config));
...
printReceipt(runTransactionProbe(
    sprintf('%s Doctrine XML transaction', getenv('PROTOTYPE_FRAMEWORK') ?: 'Symfony/Slim'),
    [
