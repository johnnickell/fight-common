...
| [Fight Common Documentation Presentation](fight-common-documentation-presentation-map.md) | Active | [Select the documentation delivery architecture](tickets/WF-033-select-documentation-delivery-architecture.md); [Design the GitHub-profile adaptation](tickets/WF-034-design-github-profile-adaptation.md); [Define compatibility and presentation quality gates](tickets/WF-035-define-compatibility-and-quality-gates.md) | Pending |
