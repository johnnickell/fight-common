...
- [Establish the portability destination and release boundaries](../../tickets/archive/WF-009-portability-destination-and-release-boundaries.md)
  ...
  incubation.
- [Define the package and repository ownership model](../../tickets/archive/WF-010-package-and-repository-ownership.md)
...
- [Research Symfony, Slim, and standalone adapter seams](../../tickets/archive/WF-023-symfony-slim-and-standalone-adapter-seams.md)
...
- [Research Laravel-native adapter seams](../../tickets/archive/WF-020-laravel-native-adapter-seams.md)
...
- [Research CodeIgniter-native adapter seams](../../tickets/archive/WF-022-codeigniter-native-adapter-seams.md)
...
- [Research Yii-native adapter seams](../../tickets/archive/WF-021-yii-native-adapter-seams.md)
...
- [Research PSR interoperability and adapter seams](../../tickets/archive/WF-025-psr-interoperability-and-adapter-seams.md)
  ...
  adapters.
- [Select the framework-adapter support matrix](../../tickets/archive/WF-024-framework-adapter-support-matrix.md)
