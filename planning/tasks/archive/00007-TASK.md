...
- TASK-00006 — Implement event mapping and upcasting.
...
The reusable `EventStoreConformanceTestCase` is the executable reference suite for TASK-00008's DBAL adapter.
The concrete in-memory tests also prove the aggregate record, release, append, read, and aggregate-owned
reconstitution journey required by TICKET-00003.
