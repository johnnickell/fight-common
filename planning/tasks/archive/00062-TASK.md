...
- [x] Repository-local agent guidance, architecture rules, planning artifacts, triage states, and completion
      authority are canonical and link back to TICKET-00016 and TICKET-00018.
- [x] TICKET-00018 is handed off as the local product and walking-slice authority, with the Symfony login extraction
      and later capability tasks remaining repository-local after bootstrap.
...
records the merged handoff. TASK-00062 is accepted. The Symfony repository now owns its TICKET-00018 capability
tasks and release decisions; this bootstrap does not authorize a release tag, Packagist publication, template
