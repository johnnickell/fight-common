...
After TASK-00035 publishes the certified release, verify Packagist's projection and install the exact public version in
...
- [x] Packagist reports `v1.2.0` with both dist and source reference
      `a2cd615d9b5064c9c30e994655536176249cd73b`, matching TASK-00035's verified tag identity.
