...
- [x] TASK-00056 supplies a successful content-addressed thin certification record covering the public API,
...
- [x] The epic, TICKETs, tasks, board, documentation, and release surfaces agree on delivered and deferred scope.
...
at `837a863000d425eb6c5b404278f41f670bd7db70`. ADR 0027 accepts that relationship while requiring TASK-00035
to merge, fetch, and freshly certify the exact remote `main` commit before signing it. Historical
`f2a0d960e19fd9d9ddcf605345220a190374ef96` certification remains recorded in TASK-00102 but is superseded as
