...
TASK-00029 — Deliver the Disposable Local Build and Dependency Modes.
...
- Planning integrity, PHPCS, PHPStan, both Deptrac checks, Rector dry-run, shell syntax, and `git diff --check`
  ...
  nonblocking existing test-cleanup duplication pattern intentionally left outside this task.
