...
Establish the shared Event Sourcing vocabulary, aggregate and storage boundaries, projection and publication guarantees, and durable planning conventions that every later task uses.
...
- [x] Downstream TICKETs and tasks use the accepted terms consistently.
