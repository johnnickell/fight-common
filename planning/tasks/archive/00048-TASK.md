...
> Historical outcome: the product compatibility delivered here remains. ADR 0025 and TASK-00056 later retired the
...
- [x] A faithful compatibility bridge is proven before the candidate is accepted. If the published behavior
      cannot be reproduced, the incompatible required-runner form is not shipped and the task stops for an
