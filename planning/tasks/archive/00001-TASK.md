...
Fight CMS Commerce is a separate greenfield opportunity, not a second TASK-00001 pilot and not a migration
...
1. **Close prerequisites in the owning repositories.** Finish the portable Fight Common aggregate, Event
   ...
   before creating implementation TICKETs or tasks. Neither prerequisite blocks Fight Common 1.2 release.
...
- Fight Common's accepted contracts were planning artifacts at the evaluation snapshot; implementation and
  consumer integration behavior remain unverified until their owning tasks complete.
