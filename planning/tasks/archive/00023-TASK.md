...
- [x] Every production coverage-ignore directive in this task's core scope is removed.
...
- Independent Standards and Spec reviews report zero findings; the task checklist grades 9/9.
