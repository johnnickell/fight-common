...
- [x] Planning conventions document task lifecycle, board order, Wayfinder, epic, TICKET, naming, and pre-PR
...
- The repaired Spec review is clean. The Standards review's implementation and documentation findings are
  resolved, with this task and board receipt closing the remaining pre-PR synchronization finding.
