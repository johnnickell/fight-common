...
status: done
blocked_by: TASK-00009,TASK-00011,TASK-00014
---
...
Publish one complete guide for manually wiring and safely operating aggregates, mapping, storage, repositories, projections, publication, failure recording, migration, and recovery. Include Symfony provider autoconfiguration only if the stretch task ships.

## Blocked By

- TASK-00009 — Implement EventSourcedRepository.
- TASK-00011 — Persist projection checkpoints with DBAL.
- TASK-00014 — Persist and log publication operational state.
...
- [x] The optional Symfony mapping-provider integration is documented only if the stretch task ships.
