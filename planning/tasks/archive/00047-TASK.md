...
> Historical outcome: ADR 0025 and TASK-00056 retained the public API manifest and real installed-consumer proof but
> replaced this task's simulated compatibility subcommand and release-test harness with `bin/release certify`.
