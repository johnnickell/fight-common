...
- [x] `release/1.2.0` is cut from freshly fetched `origin/develop` in an isolated release worktree at the
      TASK-00017-accepted candidate `6047e7c1e321acfa627bc713bec0f5802dbe58e7`.
...
- [x] The publication receipt for TASK-00041 identifies `v1.2.0`, the immutable zero-asset GitHub Release, and
...
signature verification, and peeled commit above. ADR 0027 accepts the observed zero-asset inventory; this task
