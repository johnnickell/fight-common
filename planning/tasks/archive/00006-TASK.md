...
- TASK-00005 — Define stored-event and Event Store contracts.
...
reflection, conventions, FQCN fallback, or stored-history rewriting. TASK-00007 now supplies the first concrete
Event Store that owns this complete mapper, while TASK-00015 may collect providers through Symfony.
...
- Planning validation: clean after task and board synchronization.
