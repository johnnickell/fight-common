...
status: done
blocked_by: TASK-00007,TASK-00012
---
...
- TASK-00007 — Implement the in-memory Event Store.
- TASK-00012 — Isolate synchronous dispatcher handler failures.
...
branch, while every TASK-00013 production class has exact coverage.
