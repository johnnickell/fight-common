...
- This specification is complete. Fight AccessControl owns all subsequent detailed lifecycle planning; any
  future 2.0 work begins as fresh planning there rather than in Fight Common.
...
- TICKET-00016 owns repository authority and transfer. TICKET-00018 owns framework-native starter delivery and human
  acceptance. This TICKET owns only shared AccessControl behavior and public contract assets.
- Fight Common remains the temporary specification host until the public Fight AccessControl repository is
  bootstrapped. The bootstrap handoff adopts this specification locally; later detailed task status belongs
