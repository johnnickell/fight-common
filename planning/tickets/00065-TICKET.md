...
id: T-00065
prd: PRD-00016
title: Bootstrap the Private CodeIgniter Starter and Transfer Authority
status: ready-for-agent
blocked_by: T-00061
---

# Bootstrap the Private CodeIgniter Starter and Transfer Authority

## What to Build

Establish `johnnickell/project-codeigniter` as the initially private CodeIgniter implementation home. Prove a
...
- [ ] CodeIgniter owns service configuration, module discovery, HTTP, security, persistence, queue,
...
Repository-local full build and clean-clone Composer installation, native CodeIgniter
