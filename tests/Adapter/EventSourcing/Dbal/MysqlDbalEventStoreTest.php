...
final class MysqlDbalEventStoreTest extends EventStoreConformanceTestCase
{
    ...
    public function test_that_competing_append_waits_for_the_allocation_lock_and_then_remains_contiguous(): void
    {
        ...
        $appendingConnection->executeStatement('SET SESSION innodb_lock_wait_timeout = 1');
        ...
        try {
            ...
            self::assertStringContainsString('Lock wait timeout exceeded', $exception->getMessage());
        }
