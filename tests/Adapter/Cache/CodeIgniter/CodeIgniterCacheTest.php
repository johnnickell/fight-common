...
final class CodeIgniterCacheTest extends UnitTestCase
{
    ...
    public function test_that_delete_and_clear_translate_false_results_and_native_failures(): void
    {
        /** @var CacheInterface&MockInterface $native */
        $native = $this->mock(CacheInterface::class);
        ...
        try {
            ...
            self::fail('A native false deletion must fail the Fight cache operation.');
        } catch (CacheException $exception) {
            self::assertSame('CodeIgniter cache could not delete the value.', $exception->getMessage());
        }
