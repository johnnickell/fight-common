...
#[CoversClass(StringTextDataType::class)]
class StringTextDataTypeTest extends UnitTestCase
{
    private StringTextDataType $type;
    ...
    {
        parent::setUp();
        $this->type = new StringTextDataType();
    ...
    {
        $column = ['name' => 'body'];
        $this->platform->shouldReceive('getClobTypeDeclarationSQL')->with($column)->andReturn('TEXT');
    ...
    {
        self::assertSame(StringTextDataType::TYPE_NAME, $this->type->getName());
    }
    ...
    {
        $obj = StringObject::fromString('long text content');
        $result = $this->type->convertToDatabaseValue($obj, $this->platform);

        self::assertSame('long text content', $result);
    }
    ...
    {
        $obj = StringObject::fromString('some text');
    ...
    {
        $result = $this->type->convertToPHPValue('some content', $this->platform);

        self::assertInstanceOf(StringObject::class, $result);
        self::assertSame('some content', $result->toString());
    }
