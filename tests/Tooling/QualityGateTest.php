...
final class QualityGateTest extends UnitTestCase
{
    ...
    public function test_that_quality_gate_checks_release_php_without_adding_it_to_coverage(): void
    {
        ...
        self::assertStringContainsString(
            'php vendor/bin/rector process src/ release/src/ release/scripts/ release/consumer/ --dry-run',
            $qualityGate,
        );
    }
...
php -l deptrac.php
php -l rector.php
php -l release/scripts/certify.php
...
COMMANDS,
    ...
    public static function failing_command_provider(): iterable
    {
        ...
        yield 'release PHP syntax failure' => ['php -l release/scripts/certify.php', 19];
