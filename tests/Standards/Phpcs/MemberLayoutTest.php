...
#[CoversNothing]
final class MemberLayoutTest extends UnitTestCase
{
    public function test_that_consumers_receive_the_member_layout_rules_from_the_fight_common_standard(): void
    {
        ...
        self::assertContains('Phpcs.Formatting.RequireVisibilityGroupSpacing.MissingBlankLineBetweenVisibilityGroups', $sources);
        self::assertContains('Phpcs.Formatting.RequireVisibilityGroupSpacing.UnexpectedBlankLineWithinVisibilityGroup', $sources);
    }
