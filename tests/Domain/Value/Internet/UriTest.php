...
class UriTest extends UnitTestCase
{
    ...
    public function test_that_parse_returns_expected_instance_scheme(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_authority(): void
    {
    ...
    public function test_that_parse_returns_expected_null_authority(): void
    {
    ...
    public function test_that_parse_returns_expected_empty_authority(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_user_info(): void
    {
        $uri = Uri::parse('https://username:password@mydomain.net:8110');
    ...
    public function test_that_parse_returns_expected_null_user_info(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_ipvfuture(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_ipv6(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_ipv4(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_host(): void
    {
        $uri = Uri::parse('https://username:password@mydomain.net:8110');
    ...
    public function test_that_parse_returns_expected_instance_port(): void
    {
        $uri = Uri::parse('https://username:password@mydomain.net:8110');
    ...
    public function test_that_parse_returns_expected_null_port(): void
    {
    ...
    public function test_that_parse_returns_expected_missing_port(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_path(): void
    {
    ...
    public function test_that_parse_returns_expected_empty_path(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_query(): void
    {
    ...
    public function test_that_parse_returns_expected_null_query(): void
    {
    ...
    public function test_that_parse_returns_expected_empty_query(): void
    {
        $uri = Uri::parse('https://application.net/path?');
    ...
    public function test_that_parse_returns_expected_encoded_query(): void
    {
    ...
    public function test_that_parse_returns_expected_instance_fragment(): void
    {
    ...
    public function test_that_parse_returns_expected_null_fragment(): void
    {
        $uri = Uri::parse('https://application.net/path');
    ...
    public function test_that_parse_returns_expected_empty_fragment(): void
    {
        $uri = Uri::parse('https://application.net/path#');
    ...
    public function test_that_parse_returns_expected_encoded_fragment(): void
    {
    ...
    public function test_that_resolve_passes_rfc3986_examples($ref, $expected): void
    {
    ...
    public function test_that_resolve_passes_rfc3986_non_strict_with_flag(): void
    {
        // http://tools.ietf.org/html/rfc3986#section-5.4
        $base = 'http://a/b/c/d;p?q';
    ...
    public function test_that_resolve_returns_expected_instance_empty_base_path(): void
    {
        $base = 'http://app.dev';
    ...
    public function test_that_resolve_returns_expected_instance_with_null_base_authority(): void
    {
    ...
    public function test_that_resolve_returns_expected_instance_with_null_base_authority_2(): void
    {
        $base = 'mailto:smith@example.com';
        $uri = Uri::resolve($base, './');
    ...
    public function test_that_resolve_returns_expected_instance_with_null_base_authority_3(): void
    {
        $base = 'mailto:smith@example.com';
        $uri = Uri::resolve($base, '../');
    ...
    public function test_that_from_array_returns_expected_instance(): void
    {
        $uri = Uri::fromArray([
            'scheme'    => 'http',
            'authority' => 'myapp.com',
    ...
    public function test_that_to_string_returns_user_info(): void
    {
    ...
    public function test_that_display_does_not_return_user_info(): void
    {
        $uri = Uri::parse('https://user:secret@myapp.com:8080/action?foo=bar#!wha');
