...
class ArrayStackTest extends UnitTestCase
{
    ...
    public function test_that_map_returns_a_new_stack_with_transformed_values(): void
    {
        $stack = ArrayStack::of('int');
        $stack->push(1);
        $stack->push(2);
    ...
    {
        self::assertNull(ArrayStack::of('int')->sum());
    }
    ...
    {
        self::assertNull(ArrayStack::of('int')->average());
    }
